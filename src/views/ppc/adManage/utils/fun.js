...
// 获取合计数据
export function getFormatTotal(total) {
  return {
    sales: getValueLocaleString({ value: total.sales, isFraction: true, prefix: this.currency }),
    ...
    spend: getValueLocaleString({ value: total.spend, isFraction: true, prefix: this.currency }),
    ...
    cpc: getValueLocaleString({ value: total.cpc, isFraction: true, prefix: this.currency }),
    cpa: getValueLocaleString({ value: total.cpa, isFraction: true, prefix: this.currency }),
